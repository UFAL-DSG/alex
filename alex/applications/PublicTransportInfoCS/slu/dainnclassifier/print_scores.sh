...
echo "----------------------------------------------------------------------------------------------------------"
../../../../corpustools/semscore.py ../all.trn.hdc.sem ../all.asr.hdc.sem.out
echo "----------------------------------------------------------------------------------------------------------"
...
echo "----------------------------------------------------------------------------------------------------------"
../../../../corpustools/semscore.py ../all.trn.hdc.sem ../all.nbl.hdc.sem.out
echo "----------------------------------------------------------------------------------------------------------"
...
echo "----------------------------------------------------------------------------------------------------------"
../../../../corpustools/semscore.py ../all.trn.hdc.sem ../all.trn.hdc.sem.out
echo "----------------------------------------------------------------------------------------------------------"
...
echo "----------------------------------------------------------------------------------------------------------"
../../../../corpustools/semscore.py ../dev.trn.hdc.sem ../dev.asr.hdc.sem.out
echo "----------------------------------------------------------------------------------------------------------"
...
echo "----------------------------------------------------------------------------------------------------------"
../../../../corpustools/semscore.py ../dev.trn.hdc.sem ../dev.nbl.hdc.sem.out
echo "----------------------------------------------------------------------------------------------------------"
...
echo "----------------------------------------------------------------------------------------------------------"
../../../../corpustools/semscore.py ../dev.trn.hdc.sem ../dev.trn.hdc.sem.out
echo "----------------------------------------------------------------------------------------------------------"
...
echo "----------------------------------------------------------------------------------------------------------"
../../../../corpustools/semscore.py ../test.trn.hdc.sem ../test.asr.hdc.sem.out
echo "----------------------------------------------------------------------------------------------------------"
...
echo "----------------------------------------------------------------------------------------------------------"
../../../../corpustools/semscore.py ../test.trn.hdc.sem ../test.nbl.hdc.sem.out
echo "----------------------------------------------------------------------------------------------------------"
...
echo "----------------------------------------------------------------------------------------------------------"
../../../../corpustools/semscore.py ../test.trn.hdc.sem ../test.trn.hdc.sem.out
echo "----------------------------------------------------------------------------------------------------------"
