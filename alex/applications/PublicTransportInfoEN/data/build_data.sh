...
python -c 'import autopath; from alex.utils.config import online_update; online_update("applications/PublicTransportInfoEN/data/czech.dict"); online_update("applications/PublicTransportInfoEN/data/czech.tagger"); online_update("applications/PublicTransportInfoEN/data/stops-idos.tsv")' || die 'Could not update source files'
