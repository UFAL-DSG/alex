...
class ExpandStops(object):
    ...
    def __init__(self, cases_list, strip_punct, lowercase_forms):
        ...
        analyzer_model = online_update('applications/PublicTransportInfoEN/data/czech.tagger')
        generator_model = online_update('applications/PublicTransportInfoEN/data/czech.dict')
