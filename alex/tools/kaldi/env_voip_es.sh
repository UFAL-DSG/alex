...
# Directories set up
export DATA_ROOT=`pwd`/data_voip_es  # expects subdirectories train + $TEST_SETS
export WORK=`pwd`/model_voip_es
export EXP=`pwd`/model_voip_es/exp
export TGT_MODELS=../../resources/asr/voip_es/kaldi/last
