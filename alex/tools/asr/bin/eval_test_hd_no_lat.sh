...
HDecode -A -T 1 -t $3 -C $TRAIN_COMMON/configcross -H $WORK_DIR/$1/macros -H $WORK_DIR/$1/hmmdefs -S $WORK_DIR/test.scp -i $WORK_DIR/recout_test_$8_$2.mlf -w $6 -p $4 -s $5 $DICT $WORK_DIR/tiedlist > $LOG_DIR/hdecode_test_$8_$2.log
