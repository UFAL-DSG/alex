...
python $TRAIN_SCRIPTS/CreateMLF.py $WORK_DIR/cmu_ext_dict $WORK_DIR/train_words.mlf $WORK_DIR/train.scp $TRAIN_DATA $TRAIN_DATA_SOURCE'/*.trn' > $LOG_DIR/train_missing_words.log
