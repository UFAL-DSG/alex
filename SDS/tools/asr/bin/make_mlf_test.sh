...
python $TRAIN_SCRIPTS/CreateMLF.py $WORK_DIR/cmu_ext_dict $WORK_DIR/test_words.mlf $WORK_DIR/test.scp $TEST_DATA $TEST_DATA_SOURCE'/*.trn' > $LOG_DIR/test_missing_words.log
