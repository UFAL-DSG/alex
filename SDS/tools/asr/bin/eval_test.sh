...
HVite -A -T 1 -t $3 -C $TRAIN_COMMON/configwi -H $WORK_DIR/$1/macros -H $WORK_DIR/$1/hmmdefs -S $WORK_DIR/test.scp -i $WORK_DIR/recout_test$2.mlf -w $6 -p $4 -s $5 -z lat -n 4 $WORK_DIR/dict_test $WORK_DIR/tiedlist > $LOG_DIR/hvite_test$2.log
