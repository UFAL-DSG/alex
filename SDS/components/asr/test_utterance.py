...
class TestUtteranceConfusionNetework(unittest.TestCase):
    ...
    def test_conversion_of_confnet_into_nblist_degenerated_case(self):
        ...
        correct_nblist.add(A1*B2*C1, Utterance("A1 B2 C1"))
        correct_nblist.add(A1*B3*C1, Utterance("A1 B3 C1"))
        correct_nblist.add(A2*B1*C1, Utterance("A2 B1 C1"))
        correct_nblist.add(A2*B2*C1, Utterance("A2 B2 C1"))
        correct_nblist.add(A2*B3*C1, Utterance("A2 B3 C1"))
        correct_nblist.add(A3*B1*C1, Utterance("A3 B1 C1"))
        correct_nblist.add(A3*B2*C1, Utterance("A3 B2 C1"))
        correct_nblist.add(A3*B3*C1, Utterance("A3 B3 C1"))
        correct_nblist.merge()
        correct_nblist.normalise()
        correct_nblist.sort()
        ...
        gen_nblist = confnet.get_utterance_nblist(4)
